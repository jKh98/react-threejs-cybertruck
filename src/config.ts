...
export const STREET_WIDTH = 10; // Width of the street
...
export const STREET_DEPTH = 0; // Depth of the street
export const STREET_INNER_DEPTH = 0.05; // Depth of the inner street

export const CAR_SCALE = [0.75, 0.75, 0.75];

export const CAMERA_OFFSET = new Vector3(0, 5, 10);
export const INITIAL_CAR_POSITION: [number, number, number] = [2.5, 0.2, -15];
